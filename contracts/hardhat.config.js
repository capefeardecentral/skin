...
const mainnetGwei = 46;
const INFURA_KEY = process.env.INFURA_KEY;
const MN_ETHERSCAN_API_KEY = process.env.MN_ETHERSCAN_API_KEY;
const TN_ETHERSCAN_API_KEY = process.env.TN_ETHERSCAN_API_KEY;
...
module.exports = {
  ...
  etherscan: {
    apiKey: {
      mainnet: MN_ETHERSCAN_API_KEY,
      goerli: TN_ETHERSCAN_API_KEY,
    },
  },
  abiExporter: {
    path: "./abi",
...
task("wallet", "create a wallet link", async (_, {ethers}) => {
  const wallet = ethers.Wallet.createRandom();
  const privateKey = wallet.privateKey;
  console.log("Wallet Generated as ", wallet.address);
